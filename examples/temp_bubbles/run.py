''' This runs a single working example of the temporary bubbling simulations.'''
...
if isdir('outputs/temp_bubbles_working_example') is False:
    mkdir('outputs/temp_bubbles_working_example')
...
if isfile('outputs/temp_bubbles_working_example/beta_ext.pkl') is True:
    with open('outputs/temp_bubbles_working_example/beta_ext.pkl', 'rb') as f:
        beta_ext = load(f)
else:
    growth_rate = X0
    ...
    with open('outputs/temp_bubbles_working_example/beta_ext.pkl', 'wb') as f:
        dump(beta_ext, f)
...
unmerged_exponents = array([0.5])
merged_exponents = array([0.5])

if isfile('outputs/temp_bubbles_working_example/threewise_merge_comps.pkl') is True:
    with open('outputs/temp_bubbles_working_example/threewise_merge_comps.pkl', 'rb') as f:
    ...
    with open('outputs/temp_bubbles_working_example/threewise_merge_comps.pkl', 'wb') as f:
        dump(
            (
                merged_comp_list_2,
                merged_comp_dist_2,
...
unmerged_results = create_unmerged_context([0,
                                           unmerged_exponents,
                                           t0,
                                           t_end,
                                           merge_start])

merged_populations = create_merged_systems([
        merged_exponents,
        merged_comp_list_2,
        merged_comp_dist_2,
        merged_comp_list_3,
...
results = [unpack_paramas_and_run_merge([
            0, 0,
...
fname = 'outputs/temp_bubbles_working_example/results.pkl'
