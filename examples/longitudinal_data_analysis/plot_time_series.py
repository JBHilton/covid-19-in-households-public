'''This plots the output from the single-HH model simulation
'''
...
with open('outputs/longitudinal_data_analysis/results.pkl', 'rb') as f:
...
fig.savefig('plots/longitudinal_data_analysis/time_series.png', bbox_inches='tight', dpi=300)
