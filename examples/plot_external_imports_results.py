'''This plots the results from the exernal imports test with a single set of
...
with open('simple-results.pkl', 'rb') as f:
...
with open('static-import-results.pkl', 'rb') as f:
    t, H, D, U, coarse_bds = load(f)
...
fig.savefig('static-import-plot.png', bbox_inches='tight', dpi=300)

with open('timed-import-results.pkl', 'rb') as f:
    t, H, D, U, coarse_bds = load(f)
...
fig.savefig('timed-import-plot.png', bbox_inches='tight', dpi=300)

with open('exponential-import-results.pkl', 'rb') as f:
    t, H, D, U, coarse_bds = load(f)
...
fig.savefig('exponential-import-plot.png', bbox_inches='tight', dpi=300)
